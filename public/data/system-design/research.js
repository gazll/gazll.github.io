  ...
  packs: {
    'flash-sale': {
      ...
      vi: {
        ...
        sections: [
          { title: 'Tìm saturation knee, không dùng TPS quảng cáo', items: [
          ...
          { title: 'Tách popularity khỏi correctness', items: [
          ...
          { title: 'Giới hạn demand trước khi tạo work', items: [
    ...
    reliability: {
      ...
      vi: {
        ...
        intro: 'Reliability là contract nhìn từ người dùng. Capacity, retry và failover phải là control loop có giới hạn, không phải công tắc dùng khi khẩn cấp.',
        sections: [
          { title: 'Chặn positive feedback', items: [
          ...
          { title: 'Degrade có chủ đích', items: [
          ...
          { title: 'Chứng minh khả năng recovery', items: [
    ...
    'rate-limiting': {
      ...
      vi: {
        ...
        sections: [
          { title: 'Mô hình hoá budget', items: [
            'Ưu tiên scope theo tenant/user/API key đã xác thực trước IP. Tính weighted cost cho query đắt thay vì coi mọi request tốn đúng một token.',
            'Tách sustained rate, burst capacity và concurrency. Version policy và chạy shadow trước khi enforce để đo false positive.'
          ]},
          { title: 'Giới hạn sai số phân tán', items: [
    ...
    transactions: {
      ...
      vi: {
        ...
        sections: [
          { title: 'Cho phép command lặp an toàn', items: [
          ...
          { title: 'Giữ invariant trong local transaction', items: [
          ...
          { title: 'Khép khoảng trống phân tán', items: [
    ...
    messaging: {
      ...
      vi: {
        ...
        sections: [
          { title: 'Định nghĩa delivery semantic', items: [
          ...
          { title: 'Xem lag là user impact', items: [
    ...
    caching: {
      ...
      vi: {
        ...
        sections: [
          { title: 'Chọn dữ liệu được phép stale', items: [
    ...
    'search-ranking': {
      ...
      vi: {
        ...
        sections: [
          { title: 'Tách retrieval khỏi ranking', items: [
          ...
          { title: 'Kiểm soát index freshness', items: [
          ...
          { title: 'Giới hạn cost và abuse', items: [
    ...
    'object-storage': {
      ...
      vi: {
        ...
        sections: [
          { title: 'Direct upload an toàn', items: [
          ...
          { title: 'Verify và finalize', items: [
          ...
          { title: 'Vận hành lifecycle', items: [
    ...
    observability: {
      ...
      vi: {
        ...
        sections: [
          { title: 'Bắt đầu từ user SLI', items: [
          ...
          { title: 'Giữ telemetry hữu hạn', items: [
          ...
          { title: 'Review trust boundary', items: [
    ...
    'data-evolution': {
      ...
      vi: {
        ...
        sections: [
          { title: 'Dùng đòn bẩy rẻ nhất trước', items: [
          ...
          { title: 'Chỉ tách model khi cần', items: [
          ...
          { title: 'Partition quanh invariant', items: [
